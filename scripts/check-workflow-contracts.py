...
REQUIRED_CONTRACTS = {
    ...
    "missing benchmark access": (
        "If the user selects Guidelines + Benchmarks without verified Mobbin access, treat that selection as intent to connect now.",
        "`1. Connect Mobbin now — recommended`, `2. Continue this review with Guidelines only`, `3. Cancel the review`.",
        "Verify access by actually opening Mobbin and inspecting a relevant journey",
