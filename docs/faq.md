...
| **When will Design Arc offer Stitch?** | Upfront, immediately after direction approval and before any screens are generated. Both the AI coding platform and Stitch is the recommended comparison route. | [Choosing the visual workspace](using-design-arc.md#choosing-your-ai-coding-platform-or-stitch-for-the-screens) |
...
| **What happens when I choose Both?** | The initial platform board and Stitch workspace start concurrently from the same approved specification. After comparing them independently, you choose whether to refine the platform version, the Stitch version, or both. | [Choosing the visual workspace](using-design-arc.md#choosing-your-ai-coding-platform-or-stitch-for-the-screens) |
...
| **Do I need to find and install a Stitch MCP for Codex?** | No. GitHub installs include the connection definition; Directory installs receive guided Codex configuration if it is absent. Both routes ask only for your own key and include neither the key nor Google server code. | [Design Arc for Codex](codex.md#guided-external-connections) |
| **What Mobbin plan should I use?** | Pro is recommended for an individual who needs the complete library and browsing flows; Team adds collaboration and includes Pro capabilities. Check the live plan page because availability and pricing can change. | [Design Arc for Codex](codex.md#mobbin) |
