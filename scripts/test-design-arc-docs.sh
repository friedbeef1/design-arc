...
require_text "$codex_edition" '## Guided Stitch connection'
require_text "$codex_edition" 'The Live Codex plugin already includes the Stitch MCP connection definition.'
...
require_text "$using_design_arc" 'The Live Codex plugin includes the Google-hosted Stitch MCP connection definition'
require_text "$using_design_arc" 'Google now provides an official Stitch MCP server and SDK'
require_text "$using_design_arc" 'It does not bundle Google server code, a Stitch account, or credentials.'
